...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <style dangerouslySetInnerHTML={{ __html: ".phone-intro-pending .phone-product{position:relative!important;width:432px!important;height:776px!important;visibility:visible!important;transform-style:preserve-3d!important;transform:translate3d(-57px,18px,-127px) rotateX(.095rad) rotateY(2.921rad) rotateZ(-.024rad) scale(.9)!important}.phone-intro-pending .phone-product>*:not(.phone-back){visibility:hidden!important}.phone-intro-pending .phone-product>.phone-back{position:absolute!important;inset:6px!important;display:block!important;width:420px!important;height:764px!important;visibility:visible!important;border:2px solid #50565c!important;border-radius:54px!important;background:radial-gradient(circle at 28% 16%,#23272b 0,#080a0c 24%,#010203 68%,#111417 100%)!important;box-shadow:inset 0 0 0 5px #050607,0 38px 78px rgba(0,0,0,.62)!important;backface-visibility:visible!important;transform:translateZ(-8px) rotateY(180deg)!important}" }} />
