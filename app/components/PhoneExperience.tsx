...
function PhotosApp({ base }: { base: string }) { const photos = ["/media/about/tian-xing.jpg", "/media/projects/edutool.png", "/media/projects/bebop.png", "/media/projects/quicky.jpg", "/media/projects/5279.png", "/media/projects/start-where-you-are.jpg"]; return <div className="photos-app"><div className="photo-feature"><img src={`${base}${photos[0]}`} alt="Tian Xing" /><span>About · Coming Soon</span></div><div className="photo-grid">{photos.slice(1).map((src) => <img key={src} src={`${base}${src}`} alt="Project thumbnail" />)}</div></div>; }
